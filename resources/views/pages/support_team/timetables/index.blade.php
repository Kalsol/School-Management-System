...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title font-weight-bold">Manage TimeTables</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="tab-content">
                   ...
                   <div class="col-md-8">
                        <form class="ajax-store" method="POST" action="{{ route('ttr.store') }}">
                            ...
                            <div class="text-right">
                                <button id="ajax-btn" type="submit" class="btn bg-success-800">Submit form <i class="icon-paperplane ml-2"></i></button>
                            </div>
                        </form>
                   </div>
                </div>
                ...
                @foreach($my_classes as $mc)
                    <div class="tab-pane fade" id="ttr{{ $mc->id }}">                         
                        <table class="table datatable-button-html5-columns font-size-sm">
                            ...
                            @foreach($tt_records->where('my_class_id', $mc->id) as $ttr)
                                <tr>
                                    ...
                                    <td class="font-weight-semibold">{{ $ttr->name }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    @if(Qs::userIsSuperAdmin())
                                                        <a id="{{ $ttr->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item text-danger"><i class="icon-trash"></i> Delete</a>
