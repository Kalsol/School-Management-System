                        ...
                        <div class="col-md-8">
                            <form method="post" action="{{ route('my_account.change_pass') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="current_password" name="current_password"  required type="password" class="form-control" value="{{ old('current_password') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="password_confirmation" name="password_confirmation"  required type="password" class="form-control" value="{{ old('password_confirmation') }}">
                                    </div>
                                </div>
