            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="email" value="{{ old('email') }}" name="email" required class="form-control" placeholder="Email Address">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select onchange="getStates(this.value)" required data-placeholder="Choose..." name="nal_id" id="nal_id" class="select-search form-control">
                            <option value=""></option>
                ...
                <div class="col-md-3">
                    ...
                    <select onchange="getLGA(this.value)" required data-placeholder="Choose.." name="state_id" id="state_id" class="select-search form-control">
                        <option value=""></option>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('photo') }}" accept="image/*" type="file" required name="photo" class="form-input-styled" data-fouc>
