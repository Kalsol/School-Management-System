    ...
    <div class="card-body p-1">
        ...
        <div id="accordion-{{ $untc->id }}">
            <div class="card mb-1 border-0">
                <div class="card-header" id="headingOne-{{ $untc->id }}">
                    <h5 class="mb-0 d-flex">
                        <button id="{{ $untc->id }}" class="bg-dark border-0 btn-block btn-sm mt-2" data-toggle="collapse" data-target="#collapseOne-{{ $untc->id }}" aria-expanded="true" aria-controls="collapseOne">
