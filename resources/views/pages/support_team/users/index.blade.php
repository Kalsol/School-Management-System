                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select onchange="onUserTypeChange(this)" required data-placeholder="Select User" class="form-control select" name="user_type" id="user_type">
                                        @foreach($user_types as $ut)
                                        <option value="{{ Qs::hash($ut->id) }}" data-name="{{ $ut->name }}">
                                            {{ $ut->name }}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Phone:</label>
                                    <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="+251...">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('phone2') }}" type="text" name="phone2" class="form-control" placeholder="022...">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 hidden" id="employment-date">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select onchange="getStates(this.value)" data-placeholder="Choose..." required name="nal_id" id="nal_id" class="select-search form-control">
                                        <option value=""></option>
                ...
                <table class="table datatable-button-html5-columns">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img class="rounded-circle" style="height: 40px; width: 40px;" src="{{ asset($u->photo) }}" alt="photo">{{ asset($u->photo) }}</td>
                            <td>{{ $u->name }}</td>
                            <td>{{ $u->username }}</td>
                            <td>{{ $u->phone }}</td>
                            <td>{{ $u->email }}</td>
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            ...
                                            <a href="{{ route('chat.show', Qs::hash($u->id)) }}" class="dropdown-item"><i class="icon-message"></i> Chat</a>
                                            @endif
                                            {{--Delete--}}
