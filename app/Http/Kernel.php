...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\CheckForPasswordUpdate::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'checkForPasswordUpdate' => \App\Http\Middleware\CheckForPasswordUpdate::class,
        'teamAdministrative' => \App\Http\Middleware\TeamAdministrative::class,
    ];

    protected function schedule(Schedule $schedule)
    {
        // Back up the database and files daily at 1:00 AM
        $schedule->command('backup:run')->dailyAt('01:00');

        // Remove backups older than the number of days set in config (default 16)
